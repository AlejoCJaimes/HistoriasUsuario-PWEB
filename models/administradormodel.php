...
class AdministradorModel extends Model {
    ...
    public function loadUsuarios() {
      ...
      try {
        ...
        $query = $this->db->connect()->query("SELECT u.correo_usuario as 'correo' , u.FechaCreacion_Usuario as 'fecha', rr.nombre as 'nombre' , r._status as 'estado' FROM usuario u JOIN rolusuario r ON u.Id = r.IdUsuario JOIN rol rr ON rr.id = r.IdRol ORDER BY u.FechaCreacion_Usuario DESC ");
