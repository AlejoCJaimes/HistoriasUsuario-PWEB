...
<br>
  ...
  <div class="form-group">
        <label> Nombre</label>
       <input type="text" id="nombre" REQUIRED style=" width: 400px; height: 30px;" name="Nombre" class="form-control" placeholder="Escribe el nombre">
     ...
     <div class="form-group">
        <label>URL</label>
       <input type="text" id="nombre" REQUIRED style=" width: 400px; height: 30px;" name="url" class="form-control" placeholder="https://www.w3schools.com/tags/att_img_height.asp">
    ...
    <input type="text" id="nombre" REQUIRED style=" width: 400px; height: 30px;" name="metodologia" value="<?php echo $this->metodologia;?>"class="form-control" readonly>
    </div>
    <div class="col-sm">
    <label>Estado</label>
