...
<head>
    ...
    <!-- Icons font CSS-->
    <link href="<?php echo constant('URL');?>resources/vendor/mdi-font/css/material-design-iconic-font.min.css"
    ...
    <link href="<?php echo constant('URL');?>resources/vendor/datepicker/daterangepicker.css" rel="stylesheet"
        media="all">
            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form name="formularioRegistro" method="POST"
                        action="<?php echo constant('URL');?>usuario/addDocente">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select id="rol" name="IdTipoDocumento">
                                            <option disabled="disabled" selected="selected">Seleccionar una opcion
                                            </option>
                                   ...
                                   ?>
                                            <option value="<?php echo $row['Id']?>">
                                                <?php echo $row['NombreDocumento']?></option>
                                            <?php
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="email" id="correo_usuario" name="correo_usuario"
                                        required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="password" id="clave_usuarioo"
                                        name="clave_usuario">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" id="confirmacion_clave" type="password"
                        ...
                        <div class="p-t-10">
                            ...
                            <button type="button" onclick="validarFormulario();"
                                class="btn btn--radius-2 btn--blue">Regístrate</button>
